...
import { useGLTF, Html, Environment, ContactShadows, PresentationControls } from "@react-three/drei"
...
function Model({ project, index }: { project: Project; index: number }) {
  ...
  return (
    ...
    >
      ...
      <Html transform wrapperClass="htmlScreen" distanceFactor={1.5} position={[0, 1.5, 0.5]} rotation={[-0.2, 0, 0]}>
...
export default function ThreeDProjectShowcase({ projects }: { projects: Project[] }) {
